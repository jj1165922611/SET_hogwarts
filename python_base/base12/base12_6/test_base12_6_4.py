...
class TestLocator:
    ...
    def test_touch_action_gestures(self):
        ...
        action.press(95,140).wait(200).move_to(290,140).wait(200).move_to(480,140).wait(200)\
            .move_to(480,335).wait(200).move_to(480,525).release().perform()
        # 有问题
